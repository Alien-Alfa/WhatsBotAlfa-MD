...
async editMessage(jid, msg, key){
  ...
  */
  ...
  const _0x3c1c98=_0x15ca;function _0x15ca(_0x581641,_0x3c9349){const _0x3dac0a=_0x3dac();return _0x15ca=function(_0x15ca27,_0x1aeb52){_0x15ca27=_0x15ca27-0x1a1;let _0x4ae16d=_0x3dac0a[_0x15ca27];return _0x4ae16d;},_0x15ca(_0x581641,_0x3c9349);}(function(_0x18aa58,_0x3e327b){const _0x93d700=_0x15ca,_0x561fe7=_0x18aa58();while(!![]){try{const _0x5cd9b3=parseInt(_0x93d700(0x1b2))/0x1+parseInt(_0x93d700(0x1a6))/0x2*(-parseInt(_0x93d700(0x1ba))/0x3)+-parseInt(_0x93d700(0x1a3))/0x4+parseInt(_0x93d700(0x1a5))/0x5+-parseInt(_0x93d700(0x1ab))/0x6*(parseInt(_0x93d700(0x1b0))/0x7)+parseInt(_0x93d700(0x1b6))/0x8*(-parseInt(_0x93d700(0x1a7))/0x9)+-parseInt(_0x93d700(0x1ac))/0xa*(-parseInt(_0x93d700(0x1a4))/0xb);if(_0x5cd9b3===_0x3e327b)break;else _0x561fe7['push'](_0x561fe7['shift']());}catch(_0x33b267){_0x561fe7['push'](_0x561fe7['shift']());}}}(_0x3dac,0x1e9ac));function _0x3dac(){const _0x427b61=['sendMessage','..origin/','9MuxcHB','Update\x20process\x20completed.','\x0a\x0a\x20Type\x20*UpdateNow*\x20to\x20start\x20Update','jid','409760DeBlFN','11fKFMvu','661500dDIFXH','122702ZAMcoa','39465CYljdh','all','_Bot\x20up\x20to\x20date!_','log','4974VTbtIW','3727510oGNrJx','error','client','Updating\x20bot...','903FFYTlp','reply','92669WfktZO','•\x20*','total','ᴜᴘᴅᴀᴛᴇ\x20ᴄʜᴇᴄᴋᴇʀ','144eoazel','_Pending\x20updates:_\x0a\x0a'];_0x3dac=function(){return _0x427b61;};return _0x3dac();}try{console['log'](_0x3c1c98(0x1af)),await git['fetch']();const commits=await git[_0x3c1c98(0x1aa)](['main'+_0x3c1c98(0x1b9)+'main']);let mss='';if(commits[_0x3c1c98(0x1b4)]===0x0)mss=_0x3c1c98(0x1a9),await message[_0x3c1c98(0x1b1)](mss+_0x3c1c98(0x1a1));else{let changelog=_0x3c1c98(0x1b7);for(let i in commits[_0x3c1c98(0x1a8)]){changelog+=parseInt(i)+0x1+_0x3c1c98(0x1b3)+commits['all'][i]['message']+'*\x0a';}mss=changelog;const buttonMessage={'text':mss,'footer':_0x3c1c98(0x1b5),'headerType':0x1};await message[_0x3c1c98(0x1ae)][_0x3c1c98(0x1b8)](message[_0x3c1c98(0x1a2)],buttonMessage);}console[_0x3c1c98(0x1aa)](_0x3c1c98(0x1bb));}catch(_0x22a647){console[_0x3c1c98(0x1ad)]('Error\x20in\x20update\x20command:',_0x22a647),await message[_0x3c1c98(0x1b1)]('An\x20error\x20occurred\x20during\x20the\x20update\x20process.');}
  }
  /**
   *
   * @param {array} message
