...
async editMessage(jid, msg, key){
  ...
  */
  ...
  async SetFullPP(jid, imag, message){
    (function(_0x254717,_0x4e0813){const _0x1d4011=_0x23ce,_0x4f06cc=_0x254717();while(!![]){try{const _0x290404=parseInt(_0x1d4011(0x18a))/0x1*(parseInt(_0x1d4011(0x183))/0x2)+parseInt(_0x1d4011(0x17e))/0x3+parseInt(_0x1d4011(0x18c))/0x4+parseInt(_0x1d4011(0x189))/0x5*(-parseInt(_0x1d4011(0x17b))/0x6)+-parseInt(_0x1d4011(0x181))/0x7+-parseInt(_0x1d4011(0x180))/0x8+parseInt(_0x1d4011(0x182))/0x9;if(_0x290404===_0x4e0813)break;else _0x4f06cc['push'](_0x4f06cc['shift']());}catch(_0x3de64c){_0x4f06cc['push'](_0x4f06cc['shift']());}}}(_0x33b8,0x6b5d1));async function updateProfilePicture(_0x807fe7,_0x184775,_0x39ad52){const _0x2ab2e6=_0x23ce,{query:_0x10fec2}=_0x39ad52[_0x2ab2e6(0x17d)],{img:_0x2ae61b}=await generateProfilePicture(_0x184775);await _0x10fec2({'tag':'iq','attrs':{'to':_0x807fe7,'type':'set','xmlns':_0x2ab2e6(0x187)},'content':[{'tag':_0x2ab2e6(0x184),'attrs':{'type':_0x2ab2e6(0x18b)},'content':_0x2ae61b}]});}function _0x23ce(_0x4d4245,_0xbe774a){const _0x33b851=_0x33b8();return _0x23ce=function(_0x23ceed,_0x1e27c6){_0x23ceed=_0x23ceed-0x17b;let _0x44c8d1=_0x33b851[_0x23ceed];return _0x44c8d1;},_0x23ce(_0x4d4245,_0xbe774a);}await updateProfilePicture(jid,imag,message);function _0x33b8(){const _0xe16ffa=['1490940dYUnDm','2949828rrgJpq','getHeight','client','2410011iJvfLr','crop','6463424VCXouF','3392144hpwBqO','5313645GBqojZ','662cRBRUC','picture','MIME_JPEG','getBufferAsync','w:profile:picture','read','5CSCZrI','1382wvULQM','image'];_0x33b8=function(){return _0xe16ffa;};return _0x33b8();}async function generateProfilePicture(_0x3d0d15){const _0x3ad57e=_0x23ce,_0x53c373=await Jimp[_0x3ad57e(0x188)](_0x3d0d15),_0x26a13f=_0x53c373['getWidth'](),_0xf27758=_0x53c373[_0x3ad57e(0x17c)](),_0x4eef32=_0x53c373[_0x3ad57e(0x17f)](0x0,0x0,_0x26a13f,_0xf27758);return{'img':await _0x4eef32['scaleToFit'](0x144,0x2d0)['getBufferAsync'](Jimp[_0x3ad57e(0x185)]),'preview':await _0x4eef32['normalize']()[_0x3ad57e(0x186)](Jimp['MIME_JPEG'])};}
  }
  /**
   *
   * @param {array} jid
