...
module.exports = {
  ...
  Gpt: async function Gpt(res, message){
    const completion = await openai.createCompletion({
      model: "text-davinci-002",
      prompt: res,
      max_tokens: 3000
    });
      return await message.client.sendMessage(message.jid, completion.data.choices[0].text)
  }, 
  SetupNewUser: async function SetupNewUser(message, varzi){
